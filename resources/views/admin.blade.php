<script>
    ...
    function showUserUpdateForm() {
        ...
        backgroundElement.classList.toggle("blur-sm");
        backgroundElement.classList.toggle("overflow-hidden");
        backgroundElement.classList.toggle("overscroll-auto");
    }
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500">
                                        ...
                                        @foreach($users as $user)
                                            <tr class="bg-gray-100">
                                                ...
                                                <td class="py-4 px-6 text-sm text-gray-700">
                                                    <!--onclick="showUserUpdateForm({{$user->id}})"-->
                                                    <button
                                                            onclick="showUserUpdateForm({{$user->id}})"
...
<div id="UserUpdateForm" class="hidden">
    @include('components.modal.edit',['user' => \App\Models\User::findOrFail(1)])
</div>
